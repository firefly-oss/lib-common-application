...
import com.firefly.common.application.security.DefaultSecurityAuthorizationService;
...
/**
 * Integration test for FireflySessionManager with DefaultSecurityAuthorizationService.
 * 
 * <p>Tests the authorization flow including:</p>
 * <ol>
 *   <li>Product access validation via FireflySessionManager</li>
...
class SecurityAuthorizationIntegrationTest {
    ...
    @Test
    @DisplayName("Should check specific permission via FireflySessionManager")
